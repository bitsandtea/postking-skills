...
description: List and apply saved PostKing voice profiles when generating or rewriting content, then run a de-slop pass that replaces stock LLM phrasing, filler, and canned transitions with plainer, more specific prose.
license: MIT
