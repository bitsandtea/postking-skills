...
Point your client at `https://mcp.postking.app`. See [MARKETPLACE.md](MARKETPLACE.md) for client-specific configs (Claude Desktop, Cursor, etc.).
...
├── MARKETPLACE.md                   # Client-specific install snippets
└── README.md
```
